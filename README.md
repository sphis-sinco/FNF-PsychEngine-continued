...
The original Engine aiming to be an easier alternative to newbie coders, ended production on March 31st of 2025. Now to be continued in this version!
...
## Softcoding (.lua/.hx)
For this you can head over to [the wiki](https://sphis-sinco.github.io/psychenginecontinued.lua/)

There you can learn how to use the 212 PlayState funcions in your mod!

## PEC (Psych Engine Continued) Credits:
* Macohi / Sphis - Main Programmer and Head of Psych Engine Continued

## PE (Psych Engine) Credits:
